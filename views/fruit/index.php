                ...
                <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="pull-right"><?= \yii\bootstrap\Html::button('<i class="fa fa-plus"></i> เพิ่ม', ['id'=>'btnCreate','class'=>'btn btn-sm btn-success', 'data-url'=> \yii\helpers\Url::to(['/fruit/create'])])?></div>
                            </div>
                        </div>                    
                </div>
            </div>
...
$this->registerJs("
     initFruit=function(search){
        let url = '" . \yii\helpers\Url::to(['/fruit/get-fruit']) . "';
